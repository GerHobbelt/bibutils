...
extern int bibutils_doi_test_main(int argc, const char** argv);
...
extern int bibutils_entities_test_main(int argc, const char** argv);
...
extern int bibutils_intlist_test_main(int argc, const char** argv);
...
extern int bibutils_slist_test_main(int argc, const char** argv);
extern int bibutils_str_test_main(int argc, const char** argv);
extern int bibutils_test_main(int argc, const char** argv);
extern int bibutils_utf8_test_main(int argc, const char** argv);
extern int bibutils_vplist_test_main(int argc, const char** argv);
