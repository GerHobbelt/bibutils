...
static const lookups inbook[] = {
	...
	{ "publisher",    "PUBLISHER", SIMPLE, LEVEL_HOST },
	{ "address",      "ADDRESS",   SIMPLE, LEVEL_HOST },
	{ "year",         "DATE:YEAR", DATE,   LEVEL_HOST },
	{ "month",        "DATE:MONTH",DATE,   LEVEL_HOST },
	{ "day",          "DATE:DAY",  DATE,   LEVEL_HOST },
...
static const lookups patent[] = {
	...
	{ "editor:ASIS",  "EDITOR:ASIS",    PERSON,       LEVEL_MAIN },
	{ "editor:CORP",  "EDITOR:CORP",    PERSON,       LEVEL_MAIN },
	{ "year",         "DATE:YEAR",   DATE,         LEVEL_MAIN }, /* date granted */
	{ "month",        "DATE:MONTH",  DATE,         LEVEL_MAIN },
	{ "day",          "DATE:DAY",    DATE,         LEVEL_MAIN },
	{ "yearfiled",    "DATE:YEAR",   DATE,         LEVEL_MAIN }, /* date filed */
	{ "monthfiled",   "DATE:MONTH",  DATE,         LEVEL_MAIN },
	{ "dayfiled",     "DATE:DAY",    DATE,         LEVEL_MAIN },
	{ "abstract",     "ABSTRACT",    SIMPLE,       LEVEL_MAIN },
	{ "contents",     "CONTENTS",    SIMPLE,       LEVEL_MAIN },
	{ "language",     "LANGUAGE",    SIMPLE,       LEVEL_MAIN },
	{ "location",     "LOCATION",    SIMPLE,       LEVEL_MAIN },
