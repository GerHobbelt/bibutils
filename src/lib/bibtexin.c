...
static int
bibtex_matches_list( fields *bibout, const char *tag, const char *suffix, const str *data, int level, slist *names, int *match )
{
	int n, fstatus;
	str mergedtag;
...
static void
bibtexin_notag( param *p, const char *tag )
{
