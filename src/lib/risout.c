...
static void
append_people( fields *f, const char *tag, int level, fields *out, char *ristag, int *status )
{
	vplist_index i;
	str oneperson;
	vplist people;
...
static void
append_file( fields *in, const char *tag, int level, fields *out, char *ristag, int *status )
{
	vplist_index i;
	str filename;
	int fstatus;
